...
int native_pinpad_open(JNIEnv* env, jclass obj)
{
    ...
    if(g_pPinpadInstance == NULL)
    {
        ...
        g_pPinpadInstance->set_flag_allow_bypass_pin = (pinpad_set_flag_allow_bypass_pin)dlsym(pHandle, "pinpad_set_flag_allow_bypass_pin");
...
int native_pinpad_set_flag_allow_bypass_pin(JNIEnv* env, jclass obj, int flag)
{
    hal_sys_info("native_pinpad_set_flag_allow_bypass_pin() is called:%d", flag);

    int nResult = -1;
    if (g_pPinpadInstance != NULL && g_pPinpadInstance->set_flag_allow_bypass_pin != NULL)
    {
        g_pPinpadInstance->set_flag_allow_bypass_pin(flag);
    }
    return nResult;
}
...
static JNINativeMethod g_Methods[] =
        {
                ...
                {"setFlagAllowBypass",  "(I)I",								    (void*)native_pinpad_set_flag_allow_bypass_pin},
