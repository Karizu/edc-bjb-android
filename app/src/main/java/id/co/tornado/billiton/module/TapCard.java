...
import id.co.tornado.billiton.common.BrizziCiHeader;
import id.co.tornado.billiton.common.BrizziCiStatus;
...
import id.co.tornado.billiton.handler.ISO8583Parser;
import id.co.tornado.billiton.handler.LogHandler;
...
import id.co.tornado.billiton.module.listener.TapListener;
...
//                    SETTLEMENT,
    ...
    public static final String SI_DISKON = "A24200";
...
//            writeDebugLog(TAG, "cmd: " + "DC00" + StringLib.ItoH(deductAmount) + "00 | " + "DEBIT BALANCE CardResponse: " + CardResponse);
            ...
            String TansactionData = StringLib.valToHexString(cData.getCardNumber()) +
                    ...
                    + StringLib.valToHexString("808000") // proccode
                    + StringLib.valToHexString(stan) + StringLib.valToHexString("00") + "FFFFFFFF";
