...
public class DownloadSoftware extends AsyncTask<Void, Integer, String> {
    public static final String FOLDER_LOCATION = "/sdcard/android/data/id.co.tornado.billiton/update";
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            URL url = new URL("http://"+preferences.getString("socketname",  CommonConfig.WEBSOCKET_URL) + "/device/" + Build.SERIAL + "/file");
