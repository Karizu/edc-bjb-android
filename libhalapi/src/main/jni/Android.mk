...
include $(CLEAR_VARS)
LOCAL_MODULE := jni_cloudpos_iso_fingerprint
LOCAL_SRC_FILES += hal_sys_log.c
LOCAL_SRC_FILES += iso_fingerprint/iso_fingerprint_jni_register.cpp
LOCAL_SRC_FILES += iso_fingerprint/iso_fingerprint_jni_interface.cpp
LOCAL_LDLIBS    := -llog
LOCAL_LDFLAGS += -fPIC
LOCAL_CFLAGS += -fPIC
LOCAL_CFLAGS += -Wno-psabi
...
include $(CLEAR_VARS)
LOCAL_MODULE := jni_cloudpos_terminal
LOCAL_SRC_FILES += hal_sys_log.c
LOCAL_SRC_FILES += terminal/terminal_jni_register.cpp
LOCAL_SRC_FILES += terminal/terminal_jni_interface.cpp
LOCAL_LDLIBS    := -llog
LOCAL_LDFLAGS += -fPIC
LOCAL_CFLAGS += -fPIC
LOCAL_CFLAGS += -Wno-psabi
